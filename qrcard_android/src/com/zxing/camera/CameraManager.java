...
public final class CameraManager {
  ...
  private static final int MAX_FRAME_WIDTH_V = 480;
  private static final int MAX_FRAME_HEIGHT_V = 360;
  ...
  public Rect getFramingRectV() {
	    ...
	    if (framingRect == null) {
	      ...
	      } else if (width > MAX_FRAME_WIDTH_V) {
	        width = MAX_FRAME_WIDTH_V;
	      }
	      int height = screenResolution.y * 3 / 4;
	      if (height < MIN_FRAME_HEIGHT) {
	        height = MIN_FRAME_HEIGHT;
	      } else if (height > MAX_FRAME_HEIGHT_V) {
	        height = MAX_FRAME_HEIGHT_V;
	      }
	      int leftOffset = (screenResolution.x - width) / 2;
	      int topOffset = (screenResolution.y - height) / 2;
	      framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
